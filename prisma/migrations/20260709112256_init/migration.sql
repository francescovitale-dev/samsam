...
CREATE TABLE "Setting" (
    ...
    "logoUrl" TEXT,
    "accent" TEXT NOT NULL DEFAULT '#9EC63F',
    "teal" TEXT NOT NULL DEFAULT '#5BA99B',
    "defaultMargin" DOUBLE PRECISION NOT NULL DEFAULT 15,
    "btwRate" DOUBLE PRECISION NOT NULL DEFAULT 21,
    "fixedCopy" JSONB NOT NULL,
...
CREATE TABLE "Proposal" (
    ...
    "templateType" TEXT NOT NULL DEFAULT 'battery',
    "design" TEXT NOT NULL DEFAULT 'modern',
